    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path={routesConstant.WebDesign.path}
            element={<WebDesignPage />}
          />
          <Route
            path={routesConstant.WebDevelopment.path}
            element={<WebDevelopmentPage />}
          />
          <Route
            path={routesConstant.AppDesign.path}
            element={<AppDesignPage />}
          />
          <Route
            path={routesConstant.AppDevelopment.path}
            element={<AppDevelopmentPage />}
          />
          <Route
            path={routesConstant.Ui_Ux_Design.path}
            element={<UiUxPage />}
          />
          <Route
            path={routesConstant.GraphicDesign.path}
